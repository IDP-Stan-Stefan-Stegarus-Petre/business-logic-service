        ...
        using (HttpClient client = new HttpClient())
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (responseData != null)
                {
                    ...
                    var comment = JsonConvert.DeserializeObject<EventDTO>(responseData.ToString());
                    return Ok(comment);
                }
                else
                {
        ...
        using (HttpClient client = new HttpClient())
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                if (responseData != null)
                {
                    ...
                    var pagedResponse = JsonConvert.DeserializeObject<PagedResponse<EventDTO>>(responseData.ToString());
